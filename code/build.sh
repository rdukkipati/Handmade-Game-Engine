...
mkdir -p build
pushd build
COMMON_FLAGS=(-Werror -Wall -Wextra -Wpedantic -Wconversion -Wno-unused-function -Wno-deprecated-declarations -Wno-gnu-anonymous-struct -Wno-nested-anon-types -fno-exceptions -fno-rtti)
